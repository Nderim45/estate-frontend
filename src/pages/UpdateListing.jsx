...
const UpdateListing = () => {
  ...
  const storeImage = async (file) => {
    return new Promise((resolve, reject) => {
      ...
      const storageRes = ref(storage, fileName);
      const uploadTask = uploadBytesResumable(storageRes, file);
      uploadTask.on(
        "state_changed",
        (snapshot) => {
          const progress =
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_APP_BACKEND_URL}/listing/update/${id}`,
        {
          method: "POST",
          headers: {
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex flex-wrap gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <div className="flex fllex-col items-center">
                <p>Regular Price</p>
            ...
            {formData.offer && (
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="p-3 border border-gray-300 rounded-lg"
                  onChange={handleChange}
                  value={formData.discountPrice ? formData.discountPrice : 0}
                />
                <div className="flex fllex-col items-center">
